Pod::Spec.new do |s|
    ...
    s.vendored_frameworks   = "ADTECHMobileSDK_iOS_3.4.2/Framework/ADTECHMobileSDK.framework"
    s.public_header_files   = "ADTECHMobileSDK_iOS_3.4.2/Framework/ADTECHMobileSDK.framework/Headers/*.h*"
    s.resources             = "ADTECHMobileSDK_iOS_3.4.2/Framework/ADTECHMobileSDK.framework/Resources/*"
