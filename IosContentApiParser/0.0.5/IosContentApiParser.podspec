...
#  s.description  = <<-DESC
#                   A longer description of IosContentApiParser in Markdown format.
#
...
#                   DESC
  ...
  # s.authors            = { "Vandad Nahavandipoor" => "vandad.np@gmail.com" }
  ...
  s.source       = { :git => "git@github.com:Aftonbladet/IosContentApiParser.git", :tag => "v0.0.5" }
