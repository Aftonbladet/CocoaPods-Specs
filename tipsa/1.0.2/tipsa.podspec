...
#   * Finally, don't worry about the indent, CocoaPods strips it!
    s.description      = <<-DESC
Aftonbladets Tipsa Framework now available as a pod
    DESC

    s.homepage         = "https://github.com/<GITHUB_USERNAME>/tipsa"
    s.license          = 'MIT'
    ...
    s.resource_bundles = {
    'tipsa' => ['Pod/Assets/**/*.{xib}', 'Pod/Assets/**/*.{png}', 'Pod/Assets/**/*.{plist}', 'Pod/Assets/**/*.{html}', 'Pod/Assets/**/*.{css}']
    }

    # s.public_header_files = 'Pod/Classes/**/*.h'
    s.prefix_header_file = 'Pod/TipsaLib-Prefix.pch'
    ...
    s.subspec 'Bambuser' do |bambuser|
        ...
        bambuser.vendored_libraries = 'Pod/Libraries/bambuser/libbambuser.a'
